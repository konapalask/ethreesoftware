...
const seedInitialData = async () => {
    try {
        ...
        if (count === 0) {
            console.log('Seeding initial ride data...');
            const initialRides = [
                ...
                { id: '4', name: 'Bumping Cars Double', price: 150, description: 'Classic favorite for two players.', image: 'bumping cars double/Bumper_Cars_9944_14762891777.jpg', category: 'play' },
                { id: '5', name: 'Bumping Cars Single', price: 100, description: 'Fun-filled solo driving experience.', image: 'bumping cars single/IMG_8417.jpg', category: 'play' },
                ...
                { id: '12', name: 'Kids Train', price: 100, description: 'A delightful journey for the little ones.', image: 'train ticket/IMG_8410.jpg', category: 'play' },
                { id: '13', name: 'Trampoline', price: 100, description: 'Bounce away all your energy.', image: 'trampoline/trampoline.webp', category: 'play' },
                { id: '14', name: '360 Cycle', price: 150, description: 'Thrilling 360-degree cycling experience.', image: '360 cycle/360-degree-cycle-500x500.webp', category: 'play' },
                { id: '15', name: 'Basket Ball', price: 100, description: 'Shoot hoops and win scores.', image: 'basket ball/images.jpg', category: 'play' },
                ...
                { id: '20', name: 'Combo Child (5 Rides)', price: 400, description: '5 Rides for Children.', image: 'combo child/E4LOGO.jpeg', category: 'play' },
                { id: '21', name: 'Ticket Summary Pas (5 Rides)', price: 500, description: 'Special Pass: Any 5 rides of your choice!', image: 'E4LOGO.jpeg', category: 'play' }
            ];
